  ...
  return (
    <div className="home">
      <div className="w-full flex justify-center">
        <div className="mt-10 mb-12 ml-12 flex justify-center text-center">
          <SearchBar
          ...
          />
          <h1 className="absolute top-14 right-1 md:right-10 font-bold text-lg md:text-2xl tracking-widest text-gray-500">
            Zevi
          </h1>
        </div>
      </div>
      <div className="home_panelList-wrap">
        <div className="home_panel-wrap w-[150px] p-2 md:pl-4 md:w-[220px] md:block">
          <h1 className="text-xl font-semibold mb-2 ml-3">
            Search Results
          </h1>
          <FilterPanel
            topLabel="Brand"
